...
This lab continues the campus security theme by introducing Private VLANs on two switches. The goal is to provide host isolation and granular east-west control while keeping a single IP subnet. 
